...
return [
    ...
    'timestamp' => 1750673895,
    'checksum' => '22408e557490736355f2ccdfb81a1a82',
    'files' => [
        ...
        'user/themes' => [
            'themes/underdogs-agency' => [
                'file' => 'user/themes/underdogs-agency/blueprints.yaml',
                'modified' => 1601472713
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.underdogs-agency.production-mode' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.underdogs-agency.production-mode',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.grid-size' => [
                'type' => 'select',
                'label' => 'Grid size',
                'size' => 'small',
                'options' => [
                ...
                'name' => 'themes.underdogs-agency.grid-size',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.header_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.underdogs-agency.header_section',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.custom_logo' => [
                'type' => 'file',
                'label' => 'Custom Logo',
                'size' => 'large',
                ...
                'name' => 'themes.underdogs-agency.custom_logo',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.custom_logo_mobile' => [
                'type' => 'file',
                ...
                'name' => 'themes.underdogs-agency.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.underdogs-agency.header-fixed',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.underdogs-agency.header-animated',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.underdogs-agency.header-dark',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.underdogs-agency.header-transparent',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.footer_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.underdogs-agency.footer_section',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.underdogs-agency.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.blog_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.underdogs-agency.blog_section',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.underdogs-agency.blog-page',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.spectre_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.underdogs-agency.spectre_section',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.spectre' => [
                'type' => '_parent',
                'name' => 'themes.underdogs-agency.spectre',
                'form_field' => false
            ],
            'themes.underdogs-agency.spectre.exp' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.underdogs-agency.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.underdogs-agency.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.underdogs-agency.spectre.icons',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'themes' => [
                'underdogs-agency' => [
                    'production-mode' => 'themes.underdogs-agency.production-mode',
                    'grid-size' => 'themes.underdogs-agency.grid-size',
                    'header_section' => 'themes.underdogs-agency.header_section',
                    'custom_logo' => 'themes.underdogs-agency.custom_logo',
                    'custom_logo_mobile' => 'themes.underdogs-agency.custom_logo_mobile',
                    'header-fixed' => 'themes.underdogs-agency.header-fixed',
                    'header-animated' => 'themes.underdogs-agency.header-animated',
                    'header-dark' => 'themes.underdogs-agency.header-dark',
                    'header-transparent' => 'themes.underdogs-agency.header-transparent',
                    'footer_section' => 'themes.underdogs-agency.footer_section',
                    'sticky-footer' => 'themes.underdogs-agency.sticky-footer',
                    'blog_section' => 'themes.underdogs-agency.blog_section',
                    'blog-page' => 'themes.underdogs-agency.blog-page',
                    'spectre_section' => 'themes.underdogs-agency.spectre_section',
                    'spectre' => [
                        'exp' => 'themes.underdogs-agency.spectre.exp',
                        'icons' => 'themes.underdogs-agency.spectre.icons'
                    ]
                ]
            ]
        ],
